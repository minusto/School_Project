										...
										<div class="col-sm-5">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													등록일 :
													<fmt:formatDate value="${sad.schoolRegistDate }"
														pattern="yyyy-MM-dd" />
												</div>
												<div class="panel-body">
													만료일 :
													<fmt:formatDate value="${(sad.schoolEndDate) }"
														pattern="yyyy-MM-dd" />
												</div>
															...
															<div class="modal-body col-md-8">
																...
																<div>
																	전화번호 <input type="text" class="form-control"
																		id="inputPassword3" placeholder="Tel">
																</div>
																<div>
																	삭제신청여부 <input type="text" class="form-control"
																		id="inputPassword3" placeholder="Tel">
																</div>
																<div>
																	등록일 <input type="text" class="form-control"
																		id="inputPassword3" placeholder="Password">
																</div>
																<div>
																	만료일 <input type="text" class="form-control"
																		id="inputPassword3" placeholder="Password">
																</div>
															</div>
