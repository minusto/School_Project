...
public class ResearchSubjectPackage {
	private String researchSubjectName0;
	private String researchSubjectName1;
	private String researchSubjectName2;
	private int researchSubjectOriginalScore0;
	private int researchSubjectStandardScore0;
	private double researchSubjectPercentile0;
	...
	public ResearchSubjectPackage() {}

	public ResearchSubjectPackage(String researchSubjectName0, String researchSubjectName1, String researchSubjectName2,
			int researchSubjectOriginalScore0, int researchSubjectStandardScore0, double researchSubjectPercentile0,
		...
		super();
		this.researchSubjectName0 = researchSubjectName0;
		this.researchSubjectName1 = researchSubjectName1;
		this.researchSubjectName2 = researchSubjectName2;
		this.researchSubjectOriginalScore0 = researchSubjectOriginalScore0;
		this.researchSubjectStandardScore0 = researchSubjectStandardScore0;
		this.researchSubjectPercentile0 = researchSubjectPercentile0;
	...
	public String getResearchSubjectName0() {
		return researchSubjectName0;
	}

	public void setResearchSubjectName0(String researchSubjectName0) {
		this.researchSubjectName0 = researchSubjectName0;
	}
	...
	public int getResearchSubjectOriginalScore0() {
		return researchSubjectOriginalScore0;
	}

	public void setResearchSubjectOriginalScore0(int researchSubjectOriginalScore0) {
		this.researchSubjectOriginalScore0 = researchSubjectOriginalScore0;
	}

	public int getResearchSubjectStandardScore0() {
		return researchSubjectStandardScore0;
	}

	public void setResearchSubjectStandardScore0(int researchSubjectStandardScore0) {
		this.researchSubjectStandardScore0 = researchSubjectStandardScore0;
	}

	public double getResearchSubjectPercentile0() {
		return researchSubjectPercentile0;
	}

	public void setResearchSubjectPercentile0(double researchSubjectPercentile0) {
		this.researchSubjectPercentile0 = researchSubjectPercentile0;
	}
